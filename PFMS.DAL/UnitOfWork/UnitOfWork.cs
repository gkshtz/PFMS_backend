...
namespace PFMS.DAL.UnitOfWork
{
    public class UnitOfWork: IUnitOfWork
    {
        ...
        public IRecurringTransactionsRepository<RecurringTransactionDto> RecurringTransactionsRepository => _recurringTransactionsRepository ??= new RecurringTransactionsRepository<RecurringTransactionDto, RecurringTransaction>(_appDbContext, _mapper);
